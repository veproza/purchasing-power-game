...
export default (props: TProps) => {
  ...
  const gradientHighPercentage = `${props.fillPercentage * 100}%`;
  return (
      ...
      >
        <defs id="defs9">
          <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset={gradientLowPercentage} style="stop-color:rgb(255,255,255);stop-opacity:1"/>
            <stop offset={gradientHighPercentage} style="stop-color:rgb(71,121,152);stop-opacity:1"/>
          </linearGradient>
        </defs>
        <g
